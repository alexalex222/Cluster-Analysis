...
% mode1f=[mode1_idv15.x,mode1_idv15.y];
...
label(1:100)=ones(100,1);
label(101:200)=ones(100,1)*2;

[T1,P1] = pca(dataP1,10);
knnclasslabel=clusterdata(T1,'maxclust',2,'criterion','distance','linkage','ward');
% for i=1001:2000
%     if classlabel(i)>2
%         classlabel(i)=2;
%     end
