...
mode3f=[mode3_idv1.x+0.9*distancex,mode3_idv1.y+0.9*distancey];
...
results = MB_VDP(T1',4000,0,generate_prior(T1'));
[~,classlabel]=max(results.q_z.singlets,[],2);
classlabel = classlabel([1:6:900,1001:6:1900,2001:6:2900,3001:6:4000],:);
