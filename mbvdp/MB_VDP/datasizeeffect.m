...
mode1n=mode1n([1:50:1000],:);
mode1f=mode1f([1:50:1000],:);
mode3n=mode3n([1:50:1000],:);
mode3f=mode3f([1:50:1000],:);
...
% for i=nr1/2+1:nr1
%     if classlabel(i)==2
%       faultderate=faultderate-1;
%     end
% end
% 
% faultderate=faultderate/nr1*2

modeidrate=nr1/2;
for i=nr1/2+1:0.75*nr1
    if classlabel(i)==classlabel(i-nr1/2)
        modeidrate=modeidrate-1;
    end
end
modeidrate=modeidrate/(nr1/2);
