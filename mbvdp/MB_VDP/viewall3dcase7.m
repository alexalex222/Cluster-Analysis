...
mode1f=[mode1_idv13.x,mode1_idv13.y];
mode3f=[mode3_idv1.x,mode3_idv1.y];
...
label(2001:4000,:)=classlabel2+2;
% label(1:1000,:)=1;
% label(1001:3000,:)=classlabel+1;

[Trans,Z]=LFDA(T1',label,3);
scatter3(Z(1,1:6:900),Z(2,1:6:900),Z(3,1:6:900),'og');
hold on;
scatter3(Z(1,1001:6:1900),Z(2,1001:6:1900),Z(3,1001:6:1900),'xr');
scatter3(Z(1,2001:6:2900),Z(2,2001:6:2900),Z(3,2001:6:2900),'^b');
scatter3(Z(1,3001:6:3900),Z(2,3001:6:3900),Z(3,3001:6:3900),'*m');
